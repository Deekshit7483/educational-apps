...
public class FilesActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_fab.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), ShareFileActivity.class);
				startActivity(i);
			}
		});
		...
		_file_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				file.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			View _view = _v;
			if (_view == null) {
				_view = _inflater.inflate(R.layout.share, null);
			}
			...
			if (_data.get((int)_position).containsKey("pdf name")) {
				textview1.setText(_data.get((int)_position).get("pdf name").toString());
			}
